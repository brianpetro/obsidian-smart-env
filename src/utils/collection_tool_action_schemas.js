/**
 * Shared schemas for collection retrieval tool action parameters.
 */
export const collection_tool_action_schemas = {
  limit: {
    type: 'integer',
    minimum: 1,
    description: 'Maximum number of ranked results requested from the retrieval strategy.',
  },
